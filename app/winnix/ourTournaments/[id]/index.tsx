...
const BrandDetailScreen = () => {
  ...
  return (
    <CustomFormView key={id as string}>
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={{ padding: 15, gap: 16 }}>
          {/* Back button */}
          <Pressable
            onPress={() => router.back()}
            style={[styles.back, { top: top - 30 }]}
          >
          ...
          <View style={styles.brandHeader}>
            ...
            <Text style={styles.brandMeta}>
              Marca de torneo · ID #{brand.incremental || '—'}
            </Text>
          </View>
          ...
          <View style={{ ...Flex.rowCenter, gap: 16 }}>
            ...
            >
              <WinnixIcon
                name='layers-outline'
                style={[styles.icon, { backgroundColor: Colors.secondaryDark }]}
              />
              <View style={{ gap: 4 }}>
                <CustomText label='Ediciones' size={14} color={Colors.light} />
                <CustomText
                  label={String(editions?.length || 0)}
                  size={22}
                  color={Colors.light}
                  weight='bold'
                />
            ...
            <GradientContainer
              colors={['rgba(16,185,129,0.6)', 'rgba(5,100,70,0.8)']}
              borderColor='#10b981'
            >
              <WinnixIcon
          ...
          {loadingEditions ? (
            ...
            <View style={styles.emptyEditions}>
              ...
              <Text style={styles.emptySubtext}>
                Crea la primera edición de esta marca
              </Text>
            </View>
          )}
        </View>
