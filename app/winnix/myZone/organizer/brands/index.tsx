...
const OrganizerBrandsScreen = () => {
  ...
  return (
    <MainContainerView>
      {/* FAB — Crear nueva marca */}
      <TouchableOpacity
        style={styles.fab}
        onPress={handleCreateBrand}
        activeOpacity={0.9}
      >
        <Ionicons name='add-outline' size={35} color={Colors.light} />
      </TouchableOpacity>
        ...
        {brands.length > 0 ? (
          ...
          <View style={styles.emptyStateContainer}>
            ...
            <Text style={styles.emptySubtitle}>
              Crea tu primera marca de torneo para empezar a organizar temporadas y
              competiciones.
            </Text>
            <TouchableOpacity
...
export default OrganizerBrandsScreen;
