...
export const GradientContainer = ({ colors = ["rgba(30,62,166,0.9)", "rgba(77,33,133,0.9)"], borderColor = "#ddd", containerStyle, children }: GradientContainerProps) => {
  return (
...
const styles = StyleSheet.create({
  card: {
    ...
    borderRadius: borderRadius.border_m,
