...
export const TeamEditModal: React.FC<Props> = ({ visible, team, onClose, onSubmit, isSubmitting }) => {
  ...
  return (
    <ModalRN isVisible={visible} onBackdropPress={onClose} animationIn='fadeInUp' animationOut='fadeOutDown' backdropOpacity={0.8} style={styles.modal}>
            ...
            <View style={styles.container}>
              ...
              <View style={styles.form}>
                ...
                <View style={styles.buttonRow}>
                  <View style={{ flex: 1 }}>
                    <CustomButton label='Cancelar' onPress={onClose} outline disabled={isSubmitting} />
                  </View>
                  <View style={{ flex: 1 }}>
                    <CustomButton label={isSubmitting ? "Guardando..." : "Actualizar"} onPress={handleSubmit(onValidSubmit)} icon='save-outline' disabled={isSubmitting} />
                  </View>
                </View>
              </View>
            </View>
