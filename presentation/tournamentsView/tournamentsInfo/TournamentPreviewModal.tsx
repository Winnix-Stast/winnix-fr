        ...
        <ScrollView>
          <View style={{ ...Flex.columnCenter, gap: 12, padding: 15 }}>
            ...
            <Pressable
              ...
              style={[styles.like, { top: top - 30 }]}
            >
              <WinnixIcon
                name={favorite ? 'heart' : 'heart-outline'}
                size={30}
                color={favorite ? Colors.primary : Colors.light}
              />
            </Pressable>

            <TournamentHeaderCard
              title={formData.seasonName || 'Torneo Sin Título'}
              state={stateMock}
                ...
                activities={[
                  {
                    id: '1',
                    type: 'match' as const,
                    title: 'Torneo en fase de creación',
