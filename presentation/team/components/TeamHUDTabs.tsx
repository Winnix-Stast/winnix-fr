...
const GameTab = ({ tab, isActive, onPress }: GameTabProps) => {
  ...
  return (
    <TouchableOpacity
      onPress={onPress}
      activeOpacity={0.8}
      style={styles.gameTabContainer}
    >
      <Animated.View
        style={[
          styles.gameTabBackground,
          isActive && styles.gameTabActiveBackground,
          isActive && glowStyle,
        ]}
      >
        <LinearGradient
          colors={
            isActive
              ? ['rgba(40, 209, 195, 0.3)', 'rgba(40, 209, 195, 0.05)']
      ...
      <Text
        style={[styles.gameTabLabel as TextStyle, isActive && styles.gameTabActiveLabel]}
      >
